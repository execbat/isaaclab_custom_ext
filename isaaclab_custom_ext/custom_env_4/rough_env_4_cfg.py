...
from isaaclab_custom_ext.custom_env_4.custom_velocity_env_cfg import CustomLocomotionVelocityRoughEnvCfg
from isaaclab_custom_ext.custom_env_4.objects import TARGET_MARKER, OBSTACLE_CYL
...
@configclass
class G1RoughEnv4Cfg(CustomLocomotionVelocityRoughEnvCfg):
...
@configclass
class G1RoughEnv4Cfg_PLAY(G1RoughEnv4Cfg):
